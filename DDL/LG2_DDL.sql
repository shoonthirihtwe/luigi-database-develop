...
-- Schema luigi2_test
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `luigi2_test` ;

-- -----------------------------------------------------
-- Schema luigi2_test
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `luigi2_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin ;
USE `luigi2_test` ;

-- -----------------------------------------------------
-- Table `luigi2_test`.`tenants`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`tenants` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`tenants` (
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`accident_rate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`accident_rate` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`accident_rate` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`agencies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`agencies` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`agencies` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  `corporation_individual_flag` CHAR(1) NULL DEFAULT '1' COMMENT '個人/法人フラグ',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`agency_branches`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`agency_branches` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`agency_branches` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`agency_commissions_paid`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`agency_commissions_paid` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`agency_commissions_paid` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`roles` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`roles` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`authorities`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`authorities` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`authorities` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `role_id` VARCHAR(8) NULL DEFAULT NULL COMMENT 'ロールID',
  `function_id` VARCHAR(12) NULL DEFAULT NULL COMMENT '機能ID',
  ...
  CONSTRAINT `FK_authorities_roles`
    ...
    REFERENCES `luigi2_test`.`roles` (`tenant_id` , `role_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`base_rider_mix`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`base_rider_mix` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`base_rider_mix` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`customers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`customers` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`customers` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `customer_id` VARCHAR(12) NOT NULL COMMENT '顧客ID',
  `customer_type` CHAR(1) NOT NULL COMMENT '法人/個人　区分',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`sales_products`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`sales_products` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`sales_products` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`contracts`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`contracts` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`contracts` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  `termination_date` DATE NULL DEFAULT NULL COMMENT '消滅日',
  ...
  CONSTRAINT `FK_contracts_sales_products`
    ...
    REFERENCES `luigi2_test`.`sales_products` (`tenant_id` , `sales_plan_code` , `sales_plan_type_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`beneficiaries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`beneficiaries` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`beneficiaries` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `beneficiary_code` VARCHAR(12) NULL DEFAULT NULL COMMENT '受取人ID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  `role_type` VARCHAR(2) NULL DEFAULT NULL COMMENT '役割タイプ',
  `role_sequence_no` INT(2) UNSIGNED NULL DEFAULT NULL COMMENT '連番',
  `person_type` CHAR(1) NOT NULL COMMENT '法人/個人　区分',
  `start_date` DATE NULL DEFAULT NULL COMMENT '開始日',
  `end_date` DATE NULL DEFAULT NULL COMMENT '終了日',
  ...
  `rel_ship_to_insured` VARCHAR(2) NULL DEFAULT NULL COMMENT '契約者との続柄',
  `update_count` INT(11) UNSIGNED NULL DEFAULT 1 COMMENT 'ロック用',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '作成日時',
  `created_by` VARCHAR(64) NULL DEFAULT NULL COMMENT '作成者',
  `updated_at` DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最終更新日時',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`benefits`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`benefits` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`benefits` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  `eachtime_limit_amount` INT(9) UNSIGNED NULL DEFAULT NULL COMMENT '都度支払限度額',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`benefti_limits`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`benefti_limits` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`benefti_limits` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `sales_plan_code` VARCHAR(3) NOT NULL COMMENT '保険プラン',
  `sales_plan_type_code` VARCHAR(2) NOT NULL COMMENT '販売プラン種別コード',
  ...
  `benefit_code` VARCHAR(2) NULL DEFAULT NULL COMMENT '保険金タイプ',
  `eachtime_limit_amount` INT(8) UNSIGNED NULL DEFAULT NULL COMMENT '都度支払限度額',
  ...
  CONSTRAINT `FK_benefti_limits_benefits`
    FOREIGN KEY (`tenant_id` , `sales_plan_code` , `sales_plan_type_code`)
    REFERENCES `luigi2_test`.`benefits` (`tenant_id` , `sales_plan_code` , `sales_plan_type_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`billing_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`billing_details` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`billing_details` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  `premium_sequence_no` SMALLINT(3) NULL DEFAULT NULL COMMENT '保険料　連番',
  `due_date` DATE NULL DEFAULT NULL COMMENT '充当月',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`billing_headers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`billing_headers` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`billing_headers` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `billing_period` VARCHAR(6) NULL DEFAULT NULL COMMENT '請求月',
  `payment_method_code` CHAR(1) NULL DEFAULT NULL COMMENT '払込方法コード',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`calendars`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`calendars` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`calendars` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`users` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`users` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  `remember_token` VARCHAR(255) NULL DEFAULT NULL COMMENT 'RememberMe用トークン',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`claim_headers`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `luigi2_test`.`claim_headers` (
  ...
  INDEX `CAND_claim_headers_claim_trxs_id` (`tenant_id` ASC, `claim_trxs_id` ASC),
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`claim_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`claim_details` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`claim_details` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'テナントID',
  `claim_trxs_id` INT(9) UNSIGNED NOT NULL COMMENT '保険金・給付金情報ID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  `sequence_no` TINYINT(2) NULL DEFAULT NULL COMMENT '連番',
  `active_inactive` CHAR(1) NOT NULL DEFAULT 'A' COMMENT '有効/無効フラグ',
  `base_rider` CHAR(1) NULL DEFAULT NULL COMMENT '主契約／特約区分',
  `product_type` VARCHAR(2) NULL DEFAULT NULL COMMENT '商品タイプ',
  `policy_code` VARCHAR(2) NULL DEFAULT NULL COMMENT '保険種別コード',
  ...
  `treatment_date_from` DATE NULL DEFAULT NULL COMMENT '受診・入院・手術日(from)',
  `treatment_date_to` DATE NULL DEFAULT NULL COMMENT '受診・入院・手術日(to)',
  `treatment_times` TINYINT(3) UNSIGNED NULL DEFAULT NULL COMMENT '受診回数',
  `cancer_onset_date` DATE NULL DEFAULT NULL COMMENT 'がん発生日',
  ...
  INDEX `CAND_claim_details` (`tenant_id` ASC, `claim_trxs_id` ASC, `sequence_no` ASC),
  CONSTRAINT `FK_claim_details_claim_header`
    FOREIGN KEY (`tenant_id` , `claim_trxs_id`)
    REFERENCES `luigi2_test`.`claim_headers` (`tenant_id` , `claim_trxs_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`claim_documents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`claim_documents` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`claim_documents` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `claim_trxs_id` INT(9) UNSIGNED NOT NULL COMMENT '保険金・給付金情報ID',
  `sequence_no` INT(2) UNSIGNED NOT NULL COMMENT '連番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`claim_trxs_id`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`claim_trxs_id` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`claim_trxs_id` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`code_master`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`code_master` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`code_master` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  INDEX `CAND_code_master` (`field` ASC, `tbl` ASC, `code_value` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_bin
COMMENT = '区分マスタ';
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`commission_rates`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`commission_rates` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`commission_rates` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `sales_plan_code` VARCHAR(3) NULL DEFAULT NULL COMMENT '販売プランコード',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`contract_commission_rates`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`contract_commission_rates` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`contract_commission_rates` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `sales_plan_code` VARCHAR(3) NULL DEFAULT NULL COMMENT '販売プランコード',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`contract_commissions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`contract_commissions` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`contract_commissions` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`contract_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`contract_log` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`contract_log` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '契約管理番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  `sequence_no` INT(4) UNSIGNED NULL DEFAULT NULL COMMENT '連番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`contract_no`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`contract_no` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`contract_no` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`deposit_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`deposit_details` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`deposit_details` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `entry_date` DATE NULL DEFAULT NULL COMMENT '入力日',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`deposit_headers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`deposit_headers` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`deposit_headers` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `entry_date` DATE NULL DEFAULT NULL COMMENT '入力日',
  `batch_no` INT(4) UNSIGNED NULL DEFAULT NULL COMMENT 'バッチナンバー',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`error_message`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`error_message` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`error_message` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `message_code` VARCHAR(4) NULL DEFAULT NULL COMMENT 'エラーコード',
  `message_group` VARCHAR(5) NULL DEFAULT NULL COMMENT 'エラーグループ',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`factoring_companies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`factoring_companies` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`factoring_companies` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`frequencies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`frequencies` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`frequencies` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `sequence_no` INT(2) UNSIGNED NULL DEFAULT NULL COMMENT '連番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`grace_period_infomation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`grace_period_infomation` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`grace_period_infomation` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`insurance_company`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`insurance_company` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`insurance_company` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`maintenance_requests`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`maintenance_requests` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`maintenance_requests` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  `attached_1_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類1のタイトル',
  `attached_1_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類1のURL',
  `attached_2_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類2のタイトル',
  `attached_2_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類2のURL',
  `attached_3_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類3のタイトル',
  `attached_3_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類3のURL',
  `attached_4_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類4のタイトル',
  `attached_4_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類4のURL',
  `attached_5_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類5のタイトル',
  `attached_5_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類5のURL',
  `attached_6_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類6のタイトル',
  `attached_6_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類6のURL',
  `attached_7_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類7のタイトル',
  `attached_7_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類7のURL',
  `attached_8_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類8のタイトル',
  `attached_8_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類8のURL',
  `attached_9_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類9のタイトル',
  `attached_9_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類9のURL',
  `attached_10_title` VARCHAR(64) NULL DEFAULT NULL COMMENT '添付書類10のタイトル',
  `attached_10_url` VARCHAR(256) NULL DEFAULT NULL COMMENT '添付書類10のURL',
  ...
  `token_no` VARCHAR(32) NULL DEFAULT NULL COMMENT 'カード番号(トークン)',
  `occurred_date` DATE NULL DEFAULT NULL COMMENT '消滅事由発生日',
  ...
  INDEX `FK_maintenance_requests_request_no_idx` (`tenant_id` ASC, `request_no` ASC),
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`maintenance_requests_customer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`maintenance_requests_customer` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`maintenance_requests_customer` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `request_no` VARCHAR(22) NOT NULL COMMENT '保全申請番号',
  `role` VARCHAR(2) NOT NULL COMMENT 'ロール',
  `role_sequence_no` INT(2) UNSIGNED NOT NULL COMMENT '連番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`new_business_documents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`new_business_documents` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`new_business_documents` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `sequence_no` INT(2) UNSIGNED NOT NULL COMMENT '連番',
  ...
  CONSTRAINT `FK_new_business_documents_contracts`
    ...
    REFERENCES `luigi2_test`.`contracts` (`tenant_id` , `contract_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`notifications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`notifications` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`notifications` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `notification_date` DATE NULL DEFAULT NULL COMMENT '通知予定日',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  `template_nunber` VARCHAR(6) NULL DEFAULT NULL COMMENT 'テンプレートナンバー',
  `notification_implementation` CHAR(1) NULL DEFAULT '0' COMMENT '通知実施',
  `coment` VARCHAR(1024) NULL DEFAULT NULL COMMENT '通信欄コメント',
  `sendee` TEXT NULL DEFAULT NULL COMMENT '通知対象者',
  `nitification_method` VARCHAR(2) NULL DEFAULT NULL COMMENT '通知方法',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`policy_holders_pay_method`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`policy_holders_pay_method` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`policy_holders_pay_method` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `start_date` DATE NULL DEFAULT NULL COMMENT '開始日',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`premium_for_billing_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`premium_for_billing_history` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`premium_for_billing_history` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`premium_headers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`premium_headers` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`premium_headers` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  ...
  `premium_sequence_no` SMALLINT(6) NULL DEFAULT NULL COMMENT '保険料 連番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`refund_amount`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`refund_amount` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`refund_amount` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  `request_no` VARCHAR(10) NULL DEFAULT NULL COMMENT '保全申請番号',
  `active_inactive` CHAR(1) NULL DEFAULT 'A' COMMENT '有効/無効フラグ',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`renewal_info`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`renewal_info` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`renewal_info` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`insured_objects`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`insured_objects` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`insured_objects` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`risk_headers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`risk_headers` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`risk_headers` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
  `risk_sequence_no` INT(2) UNSIGNED NULL DEFAULT NULL COMMENT '連番',
  `active_inactive` CHAR(1) NULL DEFAULT 'A' COMMENT '有効/無効フラグ',
  ...
  `expration_date` DATE NULL DEFAULT NULL COMMENT '消滅日',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`role_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`role_users` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`role_users` (
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `role_id` VARCHAR(8) NOT NULL COMMENT 'ロールID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`sales_agents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`sales_agents` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`sales_agents` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`sales_premiums`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`sales_premiums` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`sales_premiums` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `sales_plan_code` VARCHAR(3) NOT NULL COMMENT '販売プランコード',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`service_templates`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`service_templates` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`service_templates` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  `inherent_text` JSON NULL DEFAULT NULL COMMENT '固有TEXTデータ',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`service_instances`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`service_instances` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`service_instances` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  ...
  CONSTRAINT `FK_service_instances_service_templates`
    ...
    REFERENCES `luigi2_test`.`service_templates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`service_objects`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`service_objects` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`service_objects` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '証券番号枝番',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`substandard`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`substandard` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`substandard` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_branch_no` VARCHAR(2) NOT NULL COMMENT '連番',
  `insured_sequence_no` TINYINT(2) UNSIGNED NOT NULL COMMENT '補償対象連番',
  `exclusion_sequence_no` TINYINT(2) NULL COMMENT '連番',
  `product_type` VARCHAR(2) NULL DEFAULT NULL COMMENT '商品タイプ',
  `policy_code` VARCHAR(2) NULL DEFAULT NULL COMMENT '保険種別コード',
  `substandard_type` CHAR(1) NULL DEFAULT NULL COMMENT '特別条件タイプ',
  ...
  INDEX `CAND_substandard` (`tenant_id` ASC, `contract_no` ASC, `contract_branch_no` ASC, `insured_sequence_no` ASC, `exclusion_sequence_no` ASC),
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`third_party_org`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`third_party_org` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`third_party_org` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `claim_trxs_id` INT(9) UNSIGNED NOT NULL COMMENT '保険金・給付金情報ID',
  ...
  `sequence_no` TINYINT(2) NULL DEFAULT NULL COMMENT '連番',
  `org_sequence_no` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '第三者機関連番',
  ...
  INDEX `FK_third_party_org_claim_details_idx` (`tenant_id` ASC, `claim_trxs_id` ASC, `sequence_no` ASC),
  INDEX `CAND_third_party_org` (`tenant_id` ASC, `claim_trxs_id` ASC, `sequence_no` ASC, `org_sequence_no` ASC),
  CONSTRAINT `FK_third_party_org_claim_details`
    FOREIGN KEY (`tenant_id` , `claim_trxs_id` , `sequence_no`)
    REFERENCES `luigi2_test`.`claim_details` (`tenant_id` , `claim_trxs_id` , `sequence_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`underwritings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`underwritings` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`underwritings` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `contract_no` VARCHAR(10) NOT NULL COMMENT '証券番号',
  `contract_status` VARCHAR(2) NULL DEFAULT NULL COMMENT '契約ステータス',
  ...
  `card_cust_number` VARCHAR(10) NULL DEFAULT NULL COMMENT 'カード登録顧客番号　※証券番号または親証券番号',
  `card_anavailable_flag` DATE NULL DEFAULT NULL COMMENT '決済不可フラグ',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`customers_corporate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`customers_corporate` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`customers_corporate` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `customer_id` VARCHAR(12) NOT NULL COMMENT '顧客ID',
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`customers_indivisual`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`customers_indivisual` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`customers_indivisual` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `customer_id` VARCHAR(12) NOT NULL COMMENT '顧客ID',
  ...
  `deleted_by` VARCHAR(64) NULL DEFAULT NULL COMMENT '論理削除者',
  PRIMARY KEY (`id`),
  INDEX `FK_customers_indivisual_tenants` (`tenant_id` ASC),
  INDEX `CAND_customers_indivisual` (`tenant_id` ASC, `customer_id` ASC),
  INDEX `FK_customers_indivisual_guardian_idx` (`tenant_id` ASC, `guardian_id` ASC),
  CONSTRAINT `FK_customers_indivisual_customers`
    FOREIGN KEY (`tenant_id` , `customer_id`)
    REFERENCES `luigi2_test`.`customers` (`tenant_id` , `customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_customers_indivisual_tenants`
    FOREIGN KEY (`tenant_id`)
    REFERENCES `luigi2_test`.`tenants` (`id`),
  CONSTRAINT `FK_customers_indivisual_guardian`
...
-- -----------------------------------------------------
-- Table `luigi2_test`.`maintenance_documents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `luigi2_test`.`maintenance_documents` ;

CREATE TABLE IF NOT EXISTS `luigi2_test`.`maintenance_documents` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tenant_id` INT(10) UNSIGNED NOT NULL COMMENT 'テナントID',
  `request_no` VARCHAR(22) NOT NULL COMMENT '保全申請番号',
  `sequence_no` INT(2) UNSIGNED NOT NULL COMMENT '連番',
...
USE `luigi2_test`;
DROP function IF EXISTS `luigi2_test`.`getShouldtDate`;
...
USE `luigi2_test`;
DROP function IF EXISTS `luigi2_test`.`getTransferDate`;
...
USE `luigi2_test`;
DROP function IF EXISTS `luigi2_test`.`shouldtDate`;
